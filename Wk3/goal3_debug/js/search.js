...
(function() {
    ...
    //this function searches the database js for matches with the user's search term after it's been validated.    
	...
	var search = function (query) {
        ...
        console.log("~ The User's Search Term as an Array ~");
		...
		for (var i = 0, j = db.length; i < j; i++) {
			...
			console.log("Database Item Index #" + [i] + ": " + db[i]);
            console.log("Video Title in Lower Case: " + dbitem);
			...
			for (var ii = 0, jj = queryArray.length; ii < jj; ii++) {
				...
				console.log("User's Search Term: " + qitem);
				//this searches the video title for the keyword(s)
				var compare = dbitem.indexOf(qitem);
                console.log("Is the title a match? (-1 = No): " + compare);
        ...
        console.log("Finalized Results Array: ");
        console.log(results);
	...
	var showMatches = function (results) {
		...
		console.log("Result " + [i] + ": " + results[i]);
			...
			console.log("Result " + [i] + " Title: " + title);
            ...
            console.log("Result " + [i] + "'s URL: " + url)
